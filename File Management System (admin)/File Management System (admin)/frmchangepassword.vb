                ...
                If txtnp.Text = txtcnp.Text Then
                    If txtnp.Text = "" And txtcnp.Text = "" Then
                        If txtusername.Text <> "" Then
                            ...
                            If username = txtusername.Text Then
                                cmd = New MySqlCommand("UPDATE `admin` SET `username`= '" & txtusername.Text & "' ,`password`= '" & password & "' where id='" & id & "'", con)
                            Else
                    ...
                    Else
                        If txtusername.Text <> "" Then
                            ...
                            If username = txtusername.Text Then
                                cmd = New MySqlCommand("UPDATE `admin` SET `username`= '" & txtusername.Text & "' ,`password`= '" & encryptedpassword & "' where id='" & id & "'", con)
                            Else
                                cmd.CommandText = "select * from admin where username = '" & txtusername.Text & "'"
                                dr = cmd.ExecuteReader
                                If dr.HasRows Then
